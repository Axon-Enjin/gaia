...
function FeatureCard({
  ...
  return (
    <article className="flex flex-col rounded-xl border border-border-brand bg-surface-brand p-5 shadow-sm">
      ...
      <h3 className="mb-2 font-semibold text-soil-brand">{title}</h3>
      <p className="mb-4 flex-1 text-sm leading-relaxed text-text-muted-brand">
        {body}
      </p>
      <span className="w-fit rounded-md bg-growth-brand/10 px-2 py-1 text-xs font-medium text-growth-brand">
        {benefit}
      </span>
    </article>
  );
